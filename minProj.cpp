...
char line3[] = {"Computer Graphics project using OpenGL"};
char line4[] = {"Topic: Process Scheduling Algorithm"};
char line5[] = {"Shiva Teja : 1AY18CS111"};
char line6[] = {"Shyam U: 1AY18CS113"};
char line7[] = {"(Press 1 to enter the main page)"};
char op[] = {"Options:"};
char op2[] = {"1. Round Robin (RR)"};
char op3[] = {"2. Shortest Job First (SJF)"};
char op4[] = {"3. Re-enter the data"};
char op5[] = {"4. Exit :("};
...
void displayfirst(void){
    displayText(470, 450, 0,0.5, 0.5,line1);
...
//  strin("PRESS R or r TO RESET THE PROGRAM",33,15,300);
   ...
   // strin("Made by Shyam U && Shiva Teja",21,5,20);
    strin("Acharya institutes ",21,5,20);
